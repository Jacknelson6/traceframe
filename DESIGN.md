...
Design-reference shelf, film editing bin, specimen catalog, editorial contact sheet (assigned), field notebook, issue triage table, typography proof sheet. The contact sheet makes screenshot comparison the primary activity. Decorative stage lighting and sneaker packaging reduce product clarity; retain their disciplines of distinct states and consistent labeling. The application avoids decorative motion so captured websites remain the focus.
